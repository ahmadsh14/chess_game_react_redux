...
import rookWhite from "../img/rook-white.svg";
  ...
  //   const pieces = [
  //     { id: "kingB", Image: kingBlack },
  //     { id: "bishopB", Image: bishopBlack },
  //     { id: "pawnB", Image: pawnBlack },
  //     { id: "queenB", Image: queenBlack },
  //     { id: "knightB", Image: knightBlack },
  //     { id: "rookB", Image: rookBlack },
  //     { id: "kingW", Image: kingWhite },
  //     { id: "knightW", Image: knightWhite },
  //     { id: "bishopW", Image: bishopWhite },
  //     { id: "pawnW", Image: pawnWhite },
  //     { id: "queenW", Image: queenWhite },
  //     { id: "rookW", Image: rookWhite },
  //   ];
